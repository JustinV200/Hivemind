"""Roadmap step 4.4's own flood test: ten thousand events through the Queen never overflow budget.
...
`TokenBudget`, so the packer has to drop most of what it was handed.
