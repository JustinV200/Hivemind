"""Tests for hivemind.queen.ticks.human.intake: each goal request planned once, crash or not.
...
Fits into the Hive:
    Mirrors src/hivemind/queen/ticks/human/intake.py (codingrules section 3).

Key invariants:
    - None: this module holds tests only.

See Also:
    - hivemind.queen.ticks.human.intake for the drain under test.
"""
...
from hivemind.queen.ticks.human.intake import drain_goal_requests, stop_planning
