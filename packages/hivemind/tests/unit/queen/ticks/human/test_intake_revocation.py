"""Tests for hivemind.queen.ticks.human.intake under revocation: a revoked device's work never runs.
...
Fits into the Hive:
    Mirrors src/hivemind/queen/ticks/human/intake.py (codingrules section 3), split by feature.
