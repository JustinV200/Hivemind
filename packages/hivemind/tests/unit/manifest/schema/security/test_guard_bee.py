"""Tests for `[guard.bee]` and two `[guard]` keys in hivemind.manifest.schema.security.guard.
...
See Also:
    - hivemind.manifest.schema.security.guard for GuardSection, GuardBeeSection and
