"""Tests for hivemind.manifest.schema.security.guard: GuardSection and GuardRoleSection.

Fits into the Hive:
    Mirrors src/hivemind/manifest/schema/security/guard.py (codingrules section 3: tests/unit
...
See Also:
    - hivemind.manifest.schema.security.guard for the module under test.
