"""Tests for hivemind.manifest.schema.guard's `[guard.untrusted_content]` table (roadmap 10.6b).
...
See Also:
    - hivemind.manifest.schema.guard for ScanThresholds and UntrustedContentSection.
