...
14.2/5.1) from `test_loop_shutdown.py`, which proves `stop()` leaves no task behind, and from
`test_loop_alarms.py`, which follows a noted Alarm to the trail and the Warden.
"""
