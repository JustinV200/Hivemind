"""Tests for hivemind.brood_chamber.task_state: TaskStatus and TRANSITIONS.

Fits into the Hive:
    Mirrors src/hivemind/brood_chamber/task_state.py (codingrules section 3: tests/unit mirrors
    src/ one-to-one).
...
See Also:
    - hivemind.brood_chamber.task_state for the module under test.
