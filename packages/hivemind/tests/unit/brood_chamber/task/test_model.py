"""Tests for hivemind.brood_chamber.task.model: TaskSpec, TaskOutcome, Task and the graph drafts.

Fits into the Hive:
    Mirrors src/hivemind/brood_chamber/task/model.py (codingrules section 3: tests/unit mirrors
    src/ one-to-one).
...
See Also:
    - hivemind.brood_chamber.task.model for the module under test.
"""
