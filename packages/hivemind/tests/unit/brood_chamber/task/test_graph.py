"""Tests for hivemind.brood_chamber.task.graph: cycle detection, readiness, and descendants.

Fits into the Hive:
    Mirrors src/hivemind/brood_chamber/task/graph.py (codingrules section 3: tests/unit mirrors
    src/ one-to-one).
...
See Also:
    - hivemind.brood_chamber.task.graph for the module under test.
