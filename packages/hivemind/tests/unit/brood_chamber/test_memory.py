"""Tests for hivemind.brood_chamber.memory: MemoryTaskStore's own failure-atomicity behaviour.
...
Fits into the Hive:
    Mirrors src/hivemind/brood_chamber/memory.py (codingrules section 3: tests/unit mirrors
    src/ one-to-one).
...
See Also:
    - hivemind.brood_chamber.memory for the module under test.
