"""Tests for hivemind.brood_chamber.store.protocol: TaskFilter's bounds and check_task_event.
...
protocol.py itself: TaskFilter's field bounds, and check_task_event, the guard both
implementations call before every write.

Fits into the Hive:
    Mirrors src/hivemind/brood_chamber/store/protocol.py (codingrules section 3: tests/unit
...
See Also:
    - hivemind.brood_chamber.store.protocol for the module under test.
