"""Tests for hivemind.brood_chamber.store.sqlite: SqliteTaskStore, create, and restart durability.
...
Fits into the Hive:
    Mirrors src/hivemind/brood_chamber/store/sqlite.py (codingrules section 3: tests/unit mirrors
    src/ one-to-one).
...
See Also:
    - hivemind.brood_chamber.store.sqlite for the module under test.
...
from hivemind.brood_chamber.store.sqlite import SqliteTaskStore
