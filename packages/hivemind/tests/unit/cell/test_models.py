...
def test_cell_capabilities_real_display_allowed_survives_the_wire_and_defaults_off() -> None:
    allowed = make_capabilities().model_copy(update={"real_display_allowed": True})

    platform, report = allowed.to_wire()
