...
from hivemind.cli.compose.virtual_cells import _default_spec
...
def _spec() -> VirtualCellSpec:
    """The Queen's own Virtual Cell template from `[virtual_cells]` defaults: what she places by."""
    return _default_spec(VirtualCellsSection(), new_hive_id(_CLOCK))
