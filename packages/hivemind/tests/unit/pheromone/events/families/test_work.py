...
def test_cell_event_kinds_record_the_exoskeleton_attached_and_detached() -> None:
    # Roadmap step 6.4 (ADR-0031): one pair per task, never a frame or typed text.
    assert {"cell.exoskeleton_attached", "cell.exoskeleton_detached"} <= CellEvent.KINDS
