"""Tests for hivemind.pheromone.tail.follow: live-tailing the Pheromone Trail.

Fits into the Hive:
    Mirrors src/hivemind/pheromone/tail.py (codingrules section 3: tests/unit mirrors src/
    one-to-one).
...
See Also:
    - hivemind.pheromone.tail for the module under test.
"""
...
from hivemind.pheromone.tail import follow
