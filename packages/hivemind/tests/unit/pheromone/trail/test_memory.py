"""Tests for hivemind.pheromone.trail.memory: MemoryPheromoneTrail.drop_segment.
...
Fits into the Hive:
    Mirrors src/hivemind/pheromone/trail/memory.py (codingrules section 3: tests/unit mirrors
    src/ one-to-one).
...
See Also:
    - hivemind.pheromone.trail.memory for the module under test.
