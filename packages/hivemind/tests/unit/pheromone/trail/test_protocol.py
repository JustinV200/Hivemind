"""Tests for hivemind.pheromone.trail.protocol: TrailQuery, TrailSegment and TRAIL_ORDER_KEY.

Fits into the Hive:
    Mirrors src/hivemind/pheromone/trail/protocol.py (codingrules section 3: tests/unit mirrors
    src/ one-to-one).
...
See Also:
    - hivemind.pheromone.trail.protocol for the module under test.
"""
