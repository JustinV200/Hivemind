"""Tests for hivemind.pheromone.trail.sqlite: SqlitePheromoneTrail, insert_event, and migrations.
...
Fits into the Hive:
    Mirrors src/hivemind/pheromone/trail/sqlite.py (codingrules section 3: tests/unit mirrors
    src/ one-to-one).
...
See Also:
    - hivemind.pheromone.trail.sqlite for the module under test.
...
from hivemind.pheromone.trail import sqlite as pheromone_sqlite
from hivemind.pheromone.trail.protocol import TRAIL_ORDER_KEY, TrailQuery
from hivemind.pheromone.trail.sqlite import SqlitePheromoneTrail, insert_event
