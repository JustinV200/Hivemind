"""Provide PheromoneEvent and its eleven event families: the Pheromone Trail's data model.
...
Public API:
    ...
    - CellEvent, TaskEvent, AlarmEvent, ForageEvent, MemoryEvent, QueenEvent, WardenEvent,
      ToolEvent, SwarmEvent, CappingEvent, LlmEvent: the eleven event families.
