...
pheromone.trail.sqlite.apply_pheromone_migrations` reads them through `importlib.resources.files(
"hivemind.pheromone.trail.migrations")`, which is exactly why this needs to be a real Python
...
Fits into the Hive:
    Layer 1 (foundational services; capacity as data). Read by hivemind.pheromone.trail.sqlite;
...
See Also:
    ...
    - hivemind.pheromone.trail.sqlite for apply_pheromone_migrations, the one caller.
