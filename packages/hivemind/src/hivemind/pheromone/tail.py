...
Fits into the Hive:
    ...
    hivemind.observation. Calls into hivemind.pheromone.trail and waggle.clock only.
...
See Also:
    - hivemind.pheromone.trail for PheromoneTrail.query and TrailQuery, this module's only calls.
...
from hivemind.pheromone.trail import PheromoneTrail, TrailQuery
