...
Fits into the Hive:
    ...
    `hivemind.llm` (BoundModel, CallGate, UnresolvableSlotError), `hivemind.manifest.schema.guard`
    (GuardSection), `hivemind.pheromone`, `hivemind.supervision.capping` (TierTable),
    `hivemind.workers.errors` and every module of this package.
