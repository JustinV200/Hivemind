...
Fits into the Hive:
    ...
    `hivemind.manifest.schema.security.guard` (GuardBeeRuleOverride), `hivemind.pheromone` (the kind
...
from hivemind.manifest.schema.security.guard import MAX_GUARD_WINDOW_S, GuardBeeRuleOverride
