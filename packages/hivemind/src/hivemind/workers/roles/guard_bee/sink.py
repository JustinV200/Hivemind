...
implementation, exactly as `hivemind.supervision.capping.audit.FindingsSink` does for audit
...
See Also:
    - hivemind.supervision.capping.audit for FindingsSink, the seam this one mirrors.
