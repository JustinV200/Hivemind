...
Fits into the Hive:
    ...
    (CombShieldLevel), `hivemind.guard.capabilities` (CapabilitySet),
    `hivemind.manifest.schema.security.guard` (the thresholds' shape) and this package's
    `detectors`, `patterns` and `verdict`.
...
See Also:
    ...
    - hivemind.manifest.schema.security.guard for UntrustedContentSection and ScanThresholds.
"""
...
from hivemind.manifest.schema.security.guard import ScanThresholds, UntrustedContentSection
