...
Fits into the Hive:
    ...
    `hivemind.manifest.schema.security.guard` (the table shapes), `hivemind.guard.access` (the
    scratch placeholder), `hivemind.guard.capabilities` and this package's `models`, `points`
    and `table`.
...
See Also:
    ...
    - hivemind.manifest.schema.security.guard for GuardSection, the shape both sources share.
...
from hivemind.manifest.schema.security.guard import GuardRoleSection, GuardSection
