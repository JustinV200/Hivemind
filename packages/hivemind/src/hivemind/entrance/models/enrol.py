"""Define the enrol resource's bodies: a passkey's creation options, and redeeming an invite.
...
These routes are unauthenticated; every string is bounded and the code never comes back.
