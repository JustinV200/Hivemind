...
class _Hold:
    ...
    chunks: list[EncodedAudioChunk] = field(default_factory=list)
...
async def _hear_hold(
    talk: Talk, chunks: list[EncodedAudioChunk], frame: AudioEndFrame
) -> VoiceAccepted:
...
async def _replay(chunks: list[EncodedAudioChunk]) -> AsyncIterator[EncodedAudioChunk]:
