...
- **Length.** `[entrance.voice] max_clip_seconds`, read from a WAV header, or from the declared
  ...
  transcription boundary's own ceilings (25 MiB, 600 s) hold regardless.
...
- **Push-to-talk.** One hold buffers at most `MAX_HOLD_CHUNKS` frames and 25 MiB, lasts at most
