...
from hivemind.guard import Capability, CapabilityFamily, InvalidCapabilityError, file_url_escapes
...
class _AllowlistCheck:
    ...
    async def run(self, context: CheckContext) -> CheckResultRecord:
        ...
        for check in (self.path_check, self.command_check, self.network_check):
