...
4.7): `hivemind.queen.dispatcher.ready.assign.record_forage_granted` already builds a
...
See Also:
    ...
    - hivemind.queen.dispatcher for record_forage_granted, the hand-built forage.granted call
