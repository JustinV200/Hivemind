...
Fits into the Hive:
    ...
    and read by the Queen's tick (`hivemind.queen.ticks.human.chat`) and the Hive Entrance. Calls
    into `hivemind.common.errors`, `hivemind.pheromone` (QueenEvent), `hivemind.queen.errors` and
    the chat package's own model only.
