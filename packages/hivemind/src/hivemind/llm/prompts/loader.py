...
``attendant_triage.md``, ``compact_records.md``, ``judge_review.md``, ``ripen_nectar.md``,
``judge_clearance.md``): the system text a bee's awake episode (a bounded, stateless turn where a
