...
async def _refuse(warden: Warden, assignment: TaskAssign, why: str) -> None:
    ...
    # Guarded: a Queen link gone mid-hold is logged, never the end of this Warden's tick.
    await send_guarded(deps.queen_link, wrap(progress, deps.hop, clock=deps.clock))
