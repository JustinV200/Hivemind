...
PROTOCOL_VERSION = "1.3"  # What wrap() stamps: PROTOCOL_MAJOR.PROTOCOL_MINOR as the wire string.
PROTOCOL_MAJOR = 1  # A receiver rejects any other major; breaking changes bump it.
PROTOCOL_MINOR = 3  # Additive changes bump it; any minor of a known major is accepted. Bumped to
...
# TaskAssign.leaves, a new optional field (roadmap step 5.0b, "the plan declares what stays").
