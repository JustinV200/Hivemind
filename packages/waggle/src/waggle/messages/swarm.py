...
``waggle.messages.swarm_colonized``, split out by responsibility so each file stays under the
...
See Also:
    ...
    - waggle.messages.swarm_colonized for NucPromote, NucPromoted and TrailSegmentSync.
