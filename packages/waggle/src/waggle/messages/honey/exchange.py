...
live in ``waggle.messages.honey.hit``, split out by responsibility so each file stays under the
...
Fits into the Hive:
    ...
    waggle.messages.base, waggle.messages.labels and waggle.messages.honey.hit only.
...
See Also:
    ...
    - waggle.messages.honey.hit for HoneyHit and HoneyProvenance, the rest of section 8.7.
...
from waggle.messages.honey.hit import MAX_SCOPE_CHARS, SCOPE_PATTERN, HoneyHit
