...
``waggle.messages.tool_call`` and the JSON-text checks in ``waggle.messages.tool_json``, split
...
Fits into the Hive:
    ...
    waggle.messages.labels, waggle.messages.reports and waggle.messages.tool_json only.
...
See Also:
    ...
    - waggle.messages.tool_call for ToolInvoke and ToolResult, the family's other half.
    - waggle.messages.tool_json for the JSON-object check on input_schema_json.
...
from waggle.messages.tool_json import check_json_object_text
