...
notice) lives in ``waggle.messages.control_hive``, split out by responsibility so each file
...
See Also:
    ...
    - waggle.messages.control_hive for HumanMessage, MaskOverride and QueenMoved.
