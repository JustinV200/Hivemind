...
Alarms in ``waggle.messages.supervision.alarms`` and blocking questions in
``waggle.messages.supervision.questions``. Every bound is a named constant here; the number, not
...
Fits into the Hive:
    ...
    into waggle.messages.base, waggle.messages.labels and waggle.messages.supervision.telemetry
    only.
...
See Also:
    ...
    - waggle.messages.supervision.telemetry for ContextTelemetry, ChildTelemetry, CompactView
