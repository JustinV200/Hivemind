...
``waggle.messages.cell_leases`` and the Cell Wax notes in ``waggle.messages.cell_wax``, split
...
Fits into the Hive:
    ...
    the Queen; imported by waggle.messages.cell_leases for the enums and TaskNeedsReport; calls
...
See Also:
    ...
    - waggle.messages.cell_leases for the tenancy lifecycle and waggle.messages.cell_wax for
      the Cell Wax notes.
