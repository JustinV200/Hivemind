...
messages live in ``waggle.messages.forage.hosting`` and its value models in
``waggle.messages.forage.values`` and ``waggle.messages.forage.capacity``, split out by
...
Fits into the Hive:
    ...
    waggle.messages.base, waggle.messages.labels and waggle.messages.forage.values only.
...
See Also:
    ...
    - waggle.messages.forage.hosting for CapacityReport, HostingDecided, CeilingsSet and
      PlanWritten.
    - waggle.messages.forage.values for the value models and enums these messages carry.
