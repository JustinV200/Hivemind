"""Tests for waggle.messages.supervision_alarms: AlarmRaised, AlarmResolved and their value types.
...
Fits into the Hive:
    ...
    in test_supervision.py over its EXAMPLES.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.supervision_alarms for the module under test.
...
from waggle.messages.supervision_alarms import (
    MAX_DETAIL_CHARS,
    AlarmContext,
    AlarmKind,
    AlarmRaised,
