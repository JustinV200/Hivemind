"""Tests for the tool family's calling half (waggle.messages.tool_call): ToolInvoke, ToolResult.
...
Fits into the Hive:
    ...
    round trip and the enum pins live in test_tool.py.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.tool_call and waggle.messages.tool_json for the modules under test.
    - test_tool.py for EXAMPLES and the family's authoring half.
...
from waggle.messages.tool_call import (
    MAX_ARGUMENTS_CHARS,
