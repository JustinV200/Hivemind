"""Tests for waggle.messages.supervision_questions: Question, Answer and AnswerSource.
...
Fits into the Hive:
    ...
    and reason checks run in test_supervision.py over its EXAMPLES.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.supervision_questions for the module under test.
    - test_supervision.py for EXAMPLES and the checks every supervision class shares.
"""
...
from waggle.messages.supervision_questions import (
    MAX_OPTION_CHARS,
    MAX_OPTION_INDEX,
    MAX_OPTIONS,
    MAX_TEXT_CHARS,
