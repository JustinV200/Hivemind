"""Tests for the cell family: EXAMPLES for all nine classes, plus waggle.messages.cell itself.
...
Fits into the Hive:
    ...
    field; and for waggle.messages.cell (CellReady, CellHeartbeat, AttestationCheck,
    TaskNeedsReport and the family's non-wax enums) every bound and validator spec section 8.5
    names. The lease messages are tested in test_cell_leases.py and the wax messages in
    test_cell_wax.py.
...
See Also:
    - waggle.messages.cell, cell_leases and cell_wax for the modules under test.
...
from waggle.messages.cell_wax import (
    CellWaxCleared,
    CellWaxProposed,
    CellWaxWritten,
    WaxClearCause,
