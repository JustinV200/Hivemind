"""Tests for the tool family's authoring half (tool.authoring): ToolRequest and ToolPromoted.
...
See Also:
    - waggle.messages.tool.authoring for the module under test.
    - test_call.py for ToolInvoke and ToolResult, the family's other half.
...
from waggle.messages.tool.authoring import (
