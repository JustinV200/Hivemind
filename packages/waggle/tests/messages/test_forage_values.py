"""Tests for the forage family's values (waggle.messages.forage_values and forage_capacity).
...
Fits into the Hive:
    ...
    EXAMPLES, live in test_forage.py.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.forage_values and waggle.messages.forage_capacity for the modules under
      test.
