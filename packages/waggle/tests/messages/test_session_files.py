"""Tests for waggle.messages.session_files: SessionPutFile and SessionGetFile.
...
Fits into the Hive:
    ...
    family's EXAMPLES live in test_session.py.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.session_files for the module under test.
