"""Tests for waggle.messages.cell.leases: the tenancy lifecycle's four messages.
...
Fits into the Hive:
    ...
    8.5 names in both directions. The family's EXAMPLES live in test_status.py.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.cell.leases for the module under test.
...
from waggle.messages.cell.leases import (
    MAX_ALLOWED_PATHS,
    MAX_RESIDUAL_PATHS,
    CellRequest,
    CellTeardownRequest,
...
from waggle.messages.cell.status import IsolationNeed, ReleaseCause, TaskNeedsReport
