"""Tests for waggle.messages.capping_verdict: Verdict, PostconditionResult and RollbackDone.
...
Fits into the Hive:
    ...
    trip of these classes live in test_capping.py.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.capping_verdict for the module under test.
    - test_capping.py for EXAMPLES and the family's gate entry.
