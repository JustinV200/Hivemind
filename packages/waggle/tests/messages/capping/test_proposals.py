"""Tests for the capping family's gate entry (capping.proposals): the proposal and the checks.
...
See Also:
    - waggle.messages.capping.proposals for the module under test.
    - test_action.py and test_verdict.py for the family's other modules.
