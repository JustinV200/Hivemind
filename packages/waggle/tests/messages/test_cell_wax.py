"""Tests for waggle.messages.cell_wax: a Cell Wax note proposed, written and cleared.
...
Fits into the Hive:
    ...
    family's EXAMPLES and the wax enums' members live in test_cell.py.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.cell_wax for the module under test.
