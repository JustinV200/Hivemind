"""Tests for waggle.messages.swarm.colonized: NucPromote, NucPromoted and TrailSegmentSync.
...
See Also:
    - waggle.messages.swarm.colonized for the module under test.
...
from waggle.messages.swarm.colonized import (
    MAX_MODEL_ID_CHARS,
    MAX_MODELS,
    MAX_SERVER_ID_CHARS,
    NucPromote,
