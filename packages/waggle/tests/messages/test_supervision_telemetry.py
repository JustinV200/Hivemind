"""Tests for waggle.messages.supervision_telemetry: the state enums and the three value models.
...
See Also:
    - waggle.messages.supervision_telemetry for the module under test.
    - test_supervision.py for the messages that carry these models.
"""
