"""Tests for the honey family (waggle.messages.honey.exchange and hit): three classes, two values.
...
See Also:
    - waggle.messages.honey.exchange and waggle.messages.honey.hit for the modules under test.
