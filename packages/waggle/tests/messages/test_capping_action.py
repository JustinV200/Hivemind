"""Tests for waggle.messages.capping_action: ProposedAction and ActionKind.
...
See Also:
    - waggle.messages.capping_action for the module under test.
    - test_capping.py for the family's EXAMPLES, which carry one ProposedAction.
...
from waggle.messages.capping_action import (
    MAX_ACTION_CHARS,
