"""Tests for waggle.messages.session.output: SessionOutput and SessionExit.
...
Fits into the Hive:
    ...
    both directions. The family's EXAMPLES live in test_commands.py.

Key invariants:
    - None: this module holds tests only.

See Also:
    - waggle.messages.session.output for the module under test.
...
from waggle.messages.session.output import MAX_SIGNAL_NAME_CHARS, SessionExit, SessionOutput
