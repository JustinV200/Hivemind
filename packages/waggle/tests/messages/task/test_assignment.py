"""Tests for the task family (waggle.messages.task.assignment and reports): all six classes.
...
See Also:
    - waggle.messages.task.assignment and waggle.messages.task.reports for the modules under test.
