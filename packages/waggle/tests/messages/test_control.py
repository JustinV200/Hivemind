"""Tests for the control family (waggle.messages.control and control_hive): all nine classes.
...
See Also:
    - waggle.messages.control and waggle.messages.control_hive for the modules under test.
